...
var soundfiles = ["В главных ролях.mp3","Конченый.mp3","Идиот.mp3","Самый.mp3","Сексуальный.mp3","Мужик.mp3","В мире.mp3","Горячая.mp3","Чикса.mp3","Злодей.mp3","Британец.mp3","Так себе.mp3","Шутник.mp3","Пубертатная.mp3","Язва.mp3","Какой то.mp3","Мужик 2.mp3","Говнюки.mp3","Недопонятый.mp3","Гений.mp3"];
